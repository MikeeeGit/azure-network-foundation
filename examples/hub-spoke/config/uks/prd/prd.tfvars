...
subscription               = "prd"
environment                = "prd"
environment_tags           = { Environment = "prd", Scenario = "hub-spoke" }
vnet_ip_range              = "10.82.0.0/16"
dns_servers                = []
private_dns_zones          = []
...
subnets = [
  { name = "aks01", address_prefix = "10.82.0.0/22", security_group = "nsg", endpoints = [] },
  { name = "aks02", address_prefix = "10.82.4.0/22", security_group = "nsg", endpoints = [] },
  { name = "appgateway", address_prefix = "10.82.8.0/24", security_group = "nsg", endpoints = [] },
  { name = "private-endpoints", address_prefix = "10.82.9.0/24", security_group = "nsg", endpoints = [] },
  { name = "services", address_prefix = "10.82.10.0/24", security_group = "nsg", endpoints = [] },
]
